...
**Toplam 50 tool.** Tüm tools `response_format: "json"` (varsayılan) veya `"markdown"` destekler. Liste tools'ları sayfalama için `total_count`, `has_more`, `next_offset` döndürür.
...
| **Kod erişimi** | 50 MCP tool, AST-aware, hibrit arama | Yok | Yok | Yok | Yok |
...
| **Runtime** | Node.js (hafif) | Python + ChromaDB | Python + Neo4j | Python + Neo4j | Python (bulut) |

...
- `0.1.0` migrates the codebase to TypeScript and includes temporal knowledge graph, CLI-first architecture, and 52 MCP tools. Schema migrations v5-v9 are additive and backward-compatible.

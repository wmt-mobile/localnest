...
- `0.0.7-beta.2` (current beta package — temporal KG, CLI-first, 52 tools)
...
| Version | Basis | Page |
| --- | --- | --- |
| `0.0.7-beta.2` | beta package + changelog `0.0.7-beta.2` | [Beta Release Notes](./0.0.7-beta.2), [Version Archive](/docs/versions/0.0.7-beta.2/overview) |

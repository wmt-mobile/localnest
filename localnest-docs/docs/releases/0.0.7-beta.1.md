---
description: Beta release notes for localnest-mcp 0.0.7-beta.1 covering temporal knowledge graph, multi-hop traversal, nest/branch hierarchy, agent-scoped memory, semantic dedup, conversation ingestion, hooks system, CLI-first architecture, and 17 new MCP tools.
---

# 0.0.7-beta.1

Beta release notes for `localnest-mcp@0.0.7-beta.1`.
...
`0.0.7-beta.1` is the largest feature release to date. It adds a temporal knowledge graph, multi-hop graph traversal, two-level memory hierarchy, agent-scoped isolation, semantic deduplication, conversation ingestion, a hooks system, and a full CLI-first architecture. The MCP tool count grows from 35 to 52.
...
- testing `localnest-mcp@0.0.7-beta.1`
